...
1. SPELLING ERRORS - St. Mary's County, Maryland, and the District of Columbia ended up absent from the final dataset. Both had spelling inconsistencies which arose repeatedly during cleaning, and which I thought I had resolved, but I will have to check again.
